...
class GAN():
    ...
    def __init__(self,input_dim,batch_size):
        ...
        self.batch_size = batch_size
        self.z_dim =100
        self.generator_initial_dense_layer_size = (2, 2, 512)
        self.weight_save_dir ="./data/weight/face_make/128/"
        self.img_save_dir = "./data/face_make/128/"
        self._build()
    ...
    def generator_model(self):
        ...
        x = self.conv_reg(x,3,5,1,False,False,"tanh")
