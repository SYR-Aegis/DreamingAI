...
class GAN():
    ...
    def __init__(self,input_dim,batch_size):
        ...
        self.batch_size = batch_size
        self.z_dim =128
        self.generator_initial_dense_layer_size = (16, 16, 512)
        self.weight_save_dir ="./data/weight/face_make/"
        self.img_save_dir = "./data/face_make/"
        self._build()
    ...
    def generator_model(self):
        ...
        x = self.conv_reg(x,3,5,1,False,True,"tanh")
